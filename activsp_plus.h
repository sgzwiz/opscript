...
///////////////////////////////////////////////////////////////////////////////
// This header file is only included in the absence of Microsoft's official 
// header file It should be replaces as soon as an official Microsofrt header 
// becomes available
///////////////////////////////////////////////////////////////////////////////
...
DEFINE_GUID(IID_IActiveScriptSiteDebug, 0x51973C11, 0xcb0c, 0x11d0, 0xb5,
0xc9, 0x0, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
...
// STEP TYPES - defines whether we are stepping at source, bytecode, ormachine level.
...
// Used by the language engine to delegate IDebugCodeContext::GetSourceContext.
   ...
   virtual HRESULT STDMETHODCALLTYPE GetDefaultApplication( IDebugApplication **ppda) = 0; 
   ...
   virtual HRESULT STDMETHODCALLTYPE GetRootApplicationNode( IDebugApplicationNode **ppdanRoot) = 0; 
...
public:
   ...
   virtual HRESULT STDMETHODCALLTYPE Attach(IDebugDocumentHelper
*pddhParent) = 0;
...
class __declspec(uuid("51973C11-CB0C-11d0-B5C9-00A0244A0E7A")) IActiveScriptSiteDebug;
